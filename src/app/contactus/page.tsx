    ...
    return (
        <div>
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-4">Need help with literally anything? Connect with us and we'll be happy to assist you</p>
